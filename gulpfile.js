...
const path = {
    ...
    src: {
        ...
        images: srcPath + "assets/img/**/*.{jpg,jpeg,png,svg,gif,ico,webp,webmanifest,xml,json,mp4}",
...
function svgsprite() {
    return src(path.src.svgSprite, { base: srcPath + "assets/img/icons/" })
        .pipe(
            svgstore({
                inlineSvg: true,
            })
...
const build = gulp.series(clean, gulp.parallel(html, css, js, images, fonts, svgsprite))
